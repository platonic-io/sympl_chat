...
# pip3 install $HOME/.symbiont/versions/current/pytest/symbiont_io.pytest_assembly-1.1.0-py3-none-any.whl

pytest ../test/ -k test_bench_send --connection-file "$DEFAULT_NETWORK_CONFIG" --contract-path ../
